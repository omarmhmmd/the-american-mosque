    ...
    case "image":
      ...
      return (
        <figure>
          ...
          {caption && (
            <figcaption>
              {caption} <a href={value.caption[1]?.href}>{link}</a>{" "}
            </figcaption>
          )}
        </figure>
      );
...
export default function Post({ database, page, blocks }) {
...
export const getStaticProps = async () => {
  // const database = await getDatabase('3c2755967a3d41f48add6dd8c39d36ac');
